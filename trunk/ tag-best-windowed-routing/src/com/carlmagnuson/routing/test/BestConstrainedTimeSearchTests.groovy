...
class BestConstrainedTimeSearchTests extends GroovyTestCase {
	...
	void testSmallImport(){
		...
		Route r = BestConstrainedTime.findRoute(g, g.getNode(1), g.getNode(4), 0, 100);
	...
	void testLargeImport(){
		...
		long start = System.currentTimeMillis();
		Route r = BestConstrainedTime.findRoute(g, g.getNode(1), g.getNode(4), 61, 76);
